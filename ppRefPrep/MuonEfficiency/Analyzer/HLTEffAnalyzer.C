...
void HLTEffAnalyzer(
    ...
    vector<TString> branch_tags = {
        ...
        "iterL3MuonNoID", // Br 329 - 369
        "iterL3Muon", // Br 370 - 410
        "TP", // Br 411 - 447
        ...
        "hltIter0IterL3MuonTrackAssociated", // Br 542 - 576
        ...
        "hltIterL3MuonMergedAssociated", // Br 686 - 720 
        "tpTo_hltIterL3MuonMergedAssociated", // Br 721 - 757 

        "hltIterL3MuonAndMuonFromL1MergedAssociated", // Br 758 - 792
