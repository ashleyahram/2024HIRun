...
void drawtnpCompEffL3wrtL1(
  // TString efftag = "hltL3FromL2Merged", TString ver = "vRun3_01", TString SAMPLE = "Run2023", TString tag = "Muon",
  TString efftag = "hltL3Merged", TString ver = "vRun3_01", TString SAMPLE = "Run2024", TString tag = "Muon",
  // TString efftag = "hltIterL3Muon", TString ver = "vRun3_03", TString SAMPLE = "Run2022, 2023", TString tag = "Muon",
  // TString L1tag = "L1SQ0", TString L1str = "Good quality L1 muon with p_{T}^{L1} > 22 GeV",
  ...
  vector<TString> files = {
    ...
    // "../Analyzers/hist-v00-TEST-Eff.root",
    // "../Analyzer/hist-v00-TEST-Eff_700k.root",
    // "../Analyzer/hist-v00-TEST-Eff_before788k.root",
    // "../Analyzer/hist-v00-TEST-Eff_after1.4M.root" 
    // "../Analyzer/hist-v00-TEST-Eff_before788k_L1pT2.root",
    // "../Analyzer/hist-v00-TEST-Eff_after1.4M_L1pT2.root" 
    "../Analyzer/hist-v00-TEST-Eff_before788k_fixed.root",
    "../Analyzer/hist-v00-TEST-Eff_after1.4M_fixed.root" 
  };
  ...
  vector<TString> types_str = {
    ...
    // "Run2023C Data",
    // "Run2023D Data",
    "Run2023PbPb Data Before 375590",
    "Run2023PbPb Data After 375590"
  };
